<?php
  $faq = [
    $first = [
      'Q' => "<h1>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h1>",
    ...
    $second = [
      'Q' => "<h1>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h1>",
    ...
    $third = [
      'Q' => "<h1>Perché il mio account è associato a un paese?</h1>",
